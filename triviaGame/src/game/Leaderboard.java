...
public class Leaderboard{
	...
	public void writeLeaderboard() {
		try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("data/leaderboard.ser"))){
	...
	public void readLeaderboard() {
		try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("data/leaderboard.ser"))){
